...
class ProgressChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 180,
      child: CustomPaint(painter: _ProgressChartPainter(), child: Container()),
    );
  }
}
...
class _ProgressChartPainter extends CustomPainter {
  ...
  final List<double> yLabels = [5, 6, 7, 8, 9];
  final List<double> values = [5.5, 6.0, 6.5, 7.0, 7.5];
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < yLabels.length; i++) {
      ...
      // Draw Dashed Grid Line (only to the right of Y-axis line)
